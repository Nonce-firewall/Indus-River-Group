...
export default function Footer() {
  return (
    <footer className="bg-indus-blue text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-2">
              <a href="/about" className="block text-gray-300 hover:text-cerulean transition-colors">
                About Us
              </a>
              <a href="/approach" className="block text-gray-300 hover:text-cerulean transition-colors">
                Investment Approach
              </a>
              <a href="/team" className="block text-gray-300 hover:text-cerulean transition-colors">
                Team
              </a>
              <a href="/contact" className="block text-gray-300 hover:text-cerulean transition-colors">
                Contact
              </a>
            </div>
          </div>
