      ...
      <section className="py-16 bg-indus-blue text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 sm:mb-8">Our Mission</h2>
            <blockquote className="text-base sm:text-lg lg:text-xl font-serif italic leading-relaxed">
